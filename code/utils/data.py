...
class Data:
    ...
    def build_alphabet(self, input_file):
        ...
        startS = False
        startB = False
        logging.info(self.label_alphabet)
    ...
    def build_gaz_file(self, gaz_file):
        ...
        if gaz_file:
            ...
            logging.info("Load gaz file: ", gaz_file, " total size:", self.gaz.size())
        else:
    ...
    def build_gaz_alphabet(self, input_file):
        ...
        for line in in_lines:
            ...
            # empty line, indicating the end of a sentence
                ...
                word_list = []
        logging.info("gaz alphabet size:", self.gaz_alphabet.size())
    ...
    def build_word_pretrain_emb(self, emb_path):
        logging.info("build char pretrain emb...")
