...
def BIO2BMOES(input_file, output_file):
    logger.info(("Convert BIO -> BIOES for file:", input_file))
    ...
    fout.close()
    logger.info(("BIOES file generated:", output_file))



def BIOES2BIO(input_file, output_file):
    logger.info(("Convert BIOES -> BIO for file:", input_file))
    with open(input_file,'r') as in_file:
        fins = in_file.readlines()
    fout = open(output_file,'w')
    words = []
    ...
    for line in fins:
        if len(line) < 3:
            ...
            labels.append(pair[-1].upper())
    fout.close()
    logger.info(("BIO file generated:", output_file))


def IOB2BIO(input_file, output_file):
    logger.info(("Convert IOB -> BIO for file:", input_file))
    with open(input_file,'r') as in_file:
        fins = in_file.readlines()
    fout = open(output_file,'w')
    words = []
...
if __name__ == '__main__':
    ...
    # else:
    #     logger.info(("Argument error: sys.argv[1] should belongs to \"IOB2BIO/BIO2BIOES/BIOES2BIO/IOB2BIOES\""))
